...
class UppsalaWidget extends StatefulWidget {
  const UppsalaWidget({super.key});

  @override
  State<UppsalaWidget> createState() => _UppsalaWidgetState();
}

class _UppsalaWidgetState extends State<UppsalaWidget> {
