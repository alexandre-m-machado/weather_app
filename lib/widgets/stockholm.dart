...
class StockholmWidget extends StatefulWidget {
  const StockholmWidget({super.key});

  @override
  State<StockholmWidget> createState() => _StockholmWidgetState();
}

class _StockholmWidgetState extends State<StockholmWidget> {
  final _service = Services();
  final _city = 'Stockholm';
